...
// Prints out the game start page - displays the start and instructions button
...
// Directions for what to do if certain button is pressed on the startScreen page
...
// Prints out the ice cream cones on the game screen
function cones() {
...
// Directions for what to do if certain key is pressed
function keyPressed() {
...
// Directions for what to do if certain key is released
...
// Directions for what to do if mouse is clicked
...
// This checks the collisons for the scoop with the spongebob and
// counts the score and lives
...
// display the total score/lives the user scored and lost on the screen
...
// Directions for what to do if the game is over
function gameOver() {
  if (lives == 0) {
    gameIsOver = true;
  }
...
// Directions for what to do if the user pressed restart the game
function restart() {
  window.location.reload();
}

// Directions for what to do if the user pressed exit the game
function exit() {
  window.close();
}

// This checks if the user won
function checkWin() {
  if (score == 25) {
    menu = 4;
    if (gameSound.isPlaying()) {
